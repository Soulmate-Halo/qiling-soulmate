...
以下为小易（器灵内部版）真实会话界面截图，展示“省”路线下的单轮费用对比，口径为**与直连原版 CLI 相比**。

### 案例一 · 5轮简短对话

完整会话仅 5 轮，第 5 轮，器灵外包 5 次（探索 4 次、写码 1 次）/ 77 工具步 → 本轮从 **$58.068 降到 $8.504**，省 **85%**；会话累计从 **$79.673 降到 $12.845**；缓存命中 **98%**。

![5轮简短对话真实节省案例](assets/case-brief.png)

### 案例二 · 短会话

37 轮日常任务会话，第 32 轮，器灵外包 1 次 / 11 工具步 → 本轮从 **$64.351 降到 $9.210**，省 **86%**。

![短会话真实节省案例](assets/case-short.png)

### 案例三 · 长会话

246 轮大型项目会话，第 186 轮，器灵外包 6 次（含写码 3 次）/ 58 工具步 → 本轮从 **$271.624 降到 $21.957**，省 **92%**；会话累计从 **$2,567.681 降到 $378.260**；缓存命中 **98%**。

![长会话真实节省案例](assets/case-long.png)

<small>数字来自真实台账，具体节省构成见截图明细：缓存读复用、受控回填、器灵外包。三张图均基于真实台账并使用小易轮末成本组件；具体节省受任务结构影响，不构成效果承诺。</small>
